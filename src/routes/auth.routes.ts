...
import {
    validateRegister, validateLogin, validateUpdateProfile,
    validateUpdateUserLocation, validateUpdateEWalletDetails,
...
router.patch('/verification', authenticateUser, validateSellerVerification, AuthController.submitSellerVerification);
